		...
		<table class="table table-bordered table-striped table-hover">
		    ...
		    <tbody>
				<c:forEach var="cs" items="${ csList }">
					<tr>
					    <td scope="row" align="center">${cs.bno }</td>
						<td align="left"><a href="updateCs.do?bno=${cs.bno}" class="title">${ cs.title }</a></td>
					    ...
					    <c:if test="${ sessionScope.isAdmin }">
						<td align="center">
							<a href="deleteCs.do?noti_bno=${ cs.bno }" class="btn btn-danger" onclick="deleteCs()"><i class="fas fa-trash"></i></a>
						</td>
					    </c:if>
					</tr>
				</c:forEach>			
