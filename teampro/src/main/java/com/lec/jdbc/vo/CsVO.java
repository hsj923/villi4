...
public class CsVO {
	...
	public String toString() {
		return "CsVO [cs_num=" + cs_num + ", cs_name=" + cs_name + ", cs_pass=" + cs_pass + ", cs_subject=" + cs_subject
				+ ", cs_content=" + cs_content + ", cs_file=" + cs_file + ", cs_re_ref=" + cs_re_ref + ", cs_re_lev="
				+ cs_re_lev + ", cs_re_seq=" + cs_re_seq + ", cs_readcount=" + cs_readcount + ", cs_date=" + cs_date
				+ "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CsVO other = (CsVO) obj;
		return Objects.equals(cs_content, other.cs_content) && Objects.equals(cs_date, other.cs_date)
				&& Objects.equals(cs_file, other.cs_file) && Objects.equals(cs_name, other.cs_name)
				&& cs_num == other.cs_num && Objects.equals(cs_pass, other.cs_pass)
				&& cs_re_lev == other.cs_re_lev && cs_re_ref == other.cs_re_ref
				&& cs_re_seq == other.cs_re_seq && cs_readcount == other.cs_readcount
				&& Objects.equals(cs_subject, other.cs_subject);
	} 
}
