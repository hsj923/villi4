	...
	<div class="container mt-3" align="center">
		<form action="insertCs.do" method="post" enctype="multipart/form-data">
			<div class="input-group mb-3">
  				...
  				<input type="text" class="form-control" name="cs_subject" placeholder="글 제목...">
			</div>
			<div class="input-group mb-3">
  				<span class="input-group-text" id="desc_title"><i class="fas fa-user"></i></span>
  				<input type="text" class="form-control" name="cs_name" placeholder="글 작성자...">
			</div>
			<div class="input-group mb-3">
			  <span class="input-group-text"><i class="fas fa-clipboard"></i></span>
			  <textarea class="form-control"  name="cs_content" rows="15" placeholder="문의 내용..."></textarea>
			</div>	
			<div class="input-group mb-3">
