...
public class CsServiceImpl implements CsService {
	...
	@Autowired
	private com.lec.jdbc.dao.CsDAO CsDAO;
	
	@Override
	public CsVO getCs(CsVO cs) {
		return CsDAO.getCs(cs);
	}


	@Override
	public PageInfo getPageInfo(int currentPage, int perPage) {
		return CsDAO.getPageInfo("cs", currentPage, perPage);
	}

	@Override
	public List<CsVO> getCsList(int currentPage, int perPage) {
		return CsDAO.getCsList(currentPage, perPage);
	}
...
//	@Override
//	public int detailCs(CsVO cs) {
//		return CsDAO.detailCs(cs);
//	}
