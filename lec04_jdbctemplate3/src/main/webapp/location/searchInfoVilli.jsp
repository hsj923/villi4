...
#category li:hover {background: #73cec7;border-left:1px solid #acacac;margin-left: -1px;}
...
.placeinfo .title {font-weight: bold; font-size:14px;border-radius: 6px 6px 0 0;margin: -1px -1px 0 -1px;padding:10px; color: #fff;background: #73cec7;background: #73cec7 url(https://t1.daumcdn.net/localimg/localimages/07/mapapidoc/arrow_white.png) no-repeat right 14px center;}
...
<h3 class="fw-bold" align="center">내 근처 정보 찾기</h3>
	<hr/>
	<br>
	<div style="color:gray;">원하는 카테고리를 선택해보세요!</div>
<div class="map_wrap">
