...
<h3 class="fw-bold" align="center">동네 맛집 찾기</h3>
	<hr/>
<br>
	<div style="color:gray;">00동 맛집을 검색해보세요!!</div>
<div class="map_wrap">
        ...
        <div class="option">
            <div>
                <form onsubmit="searchPlaces(); return false;">
                    00동 맛집을 검색해보세요! : <input type="text" value="" id="keyword" size="17"> 
                    <button class="btn text-white btn-lg"  style="background-color: #72CCD2;" type="submit">검색하기</button> 
                </form>
            </div>
        </div>
        <hr>
