...
<!-- ============search=============== -->
	...
	<div class="container col-5 mt-5" align="center">
		...
		<form action="deleteBoard.do" method="post">
			...
			<button type="submit" class="btn btn-danger text-white mt-4 rounded-pill" ><b>"${board.getTitle()}"</b> 삭제하기</button>
			<a href="getBoardList.do" class="btn btn-dark text-white ms-3 mt-4 rounded-pill"> 게시글목록으로 돌아가기</a>
		</form>
	</div>		
</body>
</html>			