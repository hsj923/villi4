...
//	}
	...
	@RequestMapping(value="/updateBoard.do", method=RequestMethod.GET)
	public String updateBoard(Model model, BoardVO board, SearchVO searchVO, String nickname) {
		
		List<UserVO> userList = userService.getUserList(nickname);
