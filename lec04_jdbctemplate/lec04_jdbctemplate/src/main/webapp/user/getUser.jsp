	...
	<div class="container w-50 mt-4">
		...
		<section id="content">
			...
			<div class="col-2 input-group ms-3 mb-3 mt-2">
				...
				<c:if test="${ empty  user.fileName}">
					<img src="/img/noimg.png" class="rounded-circle border border-dark"
			...
			<div id="myTabs">
				<section id="user-filter">
					<ul>
						<li style="cursor: pointer"><a class="active"
							id="goodsBoardBtn">등록 게시물</a></li>
						<li style="cursor: pointer"><a id="goodsReviewBtn">거래 후기</a></li>
						<li style="cursor: pointer"><a id="goodsReportBtn">신고</a></li>

<!-- 						<li style="cursor: pointer"><div class="dropdown"> -->
<!-- 								<button class="btn dropdown-toggle" type="button" -->
<!-- 									id="dropdownMenuButton2" data-bs-toggle="dropdown" -->
<!-- 									aria-expanded="false">동네생활</button> -->
<!-- 								<ul class="dropdown-menu dropdown-menu-dark" -->
<!-- 									aria-labelledby="dropdownMenuButton2"> -->
<!-- 									<li><a id="goodsReportBtn">동네질문</a></li> -->
<!-- 									<li><a id="goodsReportBtn">분실센터</a></li> -->
<!-- 									<li><a id="goodsReportBtn">동네모임</a></li> -->
<!-- 									<li><a id="goodsReportBtn">동네투표</a></li> -->
<!-- 									<li><a id="goodsDemandBtn">빌리요청</a></li> -->
<!-- 									<li><a id="goodsReportBtn">공동구매</a></li> -->
<!-- 								</ul> -->
<!-- 							</div></li> -->
					</ul>
					...
					<c:forEach items="${MyboardList}" var="MyboardList">
						<div class="col-12 col-md-6 col-lg-4 mt-2">
							<div class="card" style="cursor: pointer;"
								onclick="location.href='updateBoard.do?seq=${MyboardList.getSeq()}';">
...
<!-- ==========================빌리요청 게시글 리스트============================ -->
<!-- 		<div class="row my-3" style="display: none;" id="goodsDemandDiv"> -->
<!-- 			<table class="table table-hover table-bordered"> -->
<!-- 				<thead class="table-dark"> -->
<!-- 					<th scope="col">글번호</th> -->
<!-- 					<th scope="col">신고대상유저</th> -->
...
<!-- 				</thead> -->
<!-- 				<tbody> -->
<%-- 					<c:forEach var="MyList" items="${ MyreportList }"> --%>
<!-- 						<tr> -->
<%-- 							<td>${ MyreportList.seq }</td> --%>
<%-- 							<td>${ MyreportList.nickname }</td> --%>
<%-- 							<td>${ MyreportList.r_rs1 }</td> --%>
