				...
				<c:if test="${ sessionScope.user.getNickname() != null }">
					<div class="col mt-3 text-end r_menu">
						<span class=mx-2><a href="#" style="text-decoration: none"
							...
							href="getUserList.do" style="text-decoration: none"
											...
											<div class="col-md-auto">
												...
												<select class="form-select" id="searchType"
													...
													<option value="address" 
														${searchVO.getSearchType()=="address" ? "selected" : ""}>위치</option>
													<option value="title"
			...
			<c:forEach items="${boardList}" var="board">
				<div class="col-12 col-md-6 col-lg-3 mt-5">
					<div class="card" style="cursor: pointer;"
						onclick="location.href='updateBoard.do?seq=${board.getSeq()}';">
						<span class="border border-dark"> <img class="card-img-top"
