...
<body>
	...
	<div class="container col-5 mt-4"  align="center">
	 	<h3 class="fw-bold">서비스 등록 게시글 작성하기</h3>
	</div>
  ...
  <path fill-rule="evenodd" d="M2 15.5V2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.74.439L8 13.069l-5.26 2.87A.5.5 0 0 1 2 15.5zm6.5-11a.5.5 0 0 0-1 0V6H6a.5.5 0 0 0 0 1h1.5v1.5a.5.5 0 0 0 1 0V7H10a.5.5 0 0 0 0-1H8.5V4.5z"/>
							...
							<option value="동행돌봄(베이비시터, 펫시터, 어르신)">동행돌봄(베이비시터, 펫시터, 어르신)</option>
							<option value="역할대행(줄서기)">역할대행(줄서기)</option>
							<option value="과외/알바">과외/알바</option>
							<option value="장보기배달">장보기배달</option>
							<option value="청소/집안일">청소/집안일</option>
							<option value="운전/카풀">운전/카풀</option>
							<option value="벌레/쥐잡기">벌레/쥐잡기</option>
							<option value="기타 등등">기타 등등</option>
