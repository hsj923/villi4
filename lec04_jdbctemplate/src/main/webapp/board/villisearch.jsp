...
.map_wrap, .map_wrap * {margin:0;padding:0;font-family: 'Pretendard-Regular';sans-serif;font-size:14px;}
        ...
        <div class="option">
            <div>
                <form onsubmit="searchPlaces(); return false;">
                    00동 맛집을 검색해보세요!! : <input type="text" value="서초동 맛집" id="keyword" size="15"> 
