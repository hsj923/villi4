...
<body>
 ...
 <header>
	<div class="container border-bottom border-dark">
		...
		<h1 class="motal-title fs-5" id="staticBackdropLabel" >비밀번호를 확인해주세요.</h1>
		</div> <!-- modal-header 끝-->
 		    ...
 		    <button  class="btn btn-info text-white"  onClick="history.back()"> 이전</button>
 		    <button  class="btn btn-info text-white"> <a class="joinbtn"  href ="login.do" >로그인</a></button>
 		    <button  class="btn btn-info text-white"> <a class="joinbtn"  href ="joinok.jsp" >회원가입</a></button>
