			...
			<div class="card">
				<div class="card-body">
					<h5 class="card-title text-start">
						<img src="resources/images/noimg.png"
							...
							height="75"><span>${lost.writer }</span> <span class="fs-5"><i
							class="bi bi-award text-warning"></i></span>
				...
				<ul class="list-group list-group-flush">
					<li class="list-group-item text-start"><span
						class="fs-4 fw-bold">${ lost.title }</span>
						<p class="text-muted fs-6 fst-italic">${lost.regDate}</p> <br>
						<br>
						<p class="text-muted fs-5">${ lost.content }</p> <c:if
							test="${ !empty  lost.fileName1}">
							<img class="rounded mx-auto d-block"
								src="resources/images/${ lost.fileName1 }" height="600px"
								alt="img" />
						</c:if> <c:if test="${ empty  lost.fileName1}">
