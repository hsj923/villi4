...
<!-- ============search=============== -->
				...
				<div class="col">
					...
					<nav class="navbar navbar-expand-lg navbar-light">
						<div class="container-fluid">
							<a class="navbar-brand" href="getMeetingList.do">Villi</a>
									...
									<li class="nav-item">
										...
										<div class="dropdown">
											...
											<ul class="dropdown-menu dropdown-menu-dark"
												...
												<li><a class="dropdown-item" href="meeting/insertMeeting.jsp">상품</a></li>
												<li><a class="dropdown-item" href="meeting_sinsert.jsp">서비스</a></li>
											</ul>
										</div>
	...
	<div class="container col-5 mt-5" align="center">
		...
		<form action="deleteMeeting.do" method="post">
			<input type="hidden" name="seq" value="${ meeting.getSeq()}">
			...
			<button type="submit" class="btn btn-danger text-white mt-4 rounded-pill" ><b>"${meeting.getTitle()}"</b> 삭제하기</button>
			<a href="getMeetingList.do" class="btn btn-dark text-white ms-3 mt-4 rounded-pill"> 게시글목록으로 돌아가기</a>
		</form>
	</div>		
</body>
</html>			