...
public class NoticeController {
	...
	public String deleteNotice(Model model, NoticeVO notice, SearchVO searchVO, @RequestParam int noti_seq) {
		notice.setNoti_seq(noti_seq);
		model.addAttribute("searchVO", searchVO);
		model.addAttribute("board" , noticeService.getNotice(notice));
		return "notice/deleteNotice.jsp";
	}
