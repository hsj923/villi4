		...
		<h3 class="fw-bold">회원가입</h3>
			...
			<br/>
						...
						<div class="input-group mb-2">
							...
							<input type="text" name="email" class="form-control" id="email" value="${userInfo.email}" disabled  required placeholder="이메일"  >
						</div> 
					...
					<div class="pwok">
						...
						<div class="input-group mb-3 mt-4">
							...
							<input type="text" name="nickname" class="form-control" id="nickname" value="${userInfo.nickname}" disabled required placeholder="닉네임">
						</div>
