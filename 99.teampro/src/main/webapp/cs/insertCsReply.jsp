...
<!----------- 본문 ----------->
   ...
   <div class="container my-4" align="center">
			<h3 class="fw-bold">문의사항 댓글 작성</h3>	
	</div>
	<hr>

	<div class="container mt-5" align="center">
		<form action="insertCsReply.do" method="post" enctype="multipart/form-data">
			<div class="input-group mb-3 w-75">
  				<input type="text" class="form-control" name="writer" placeholder="제목을 입력하세요">
			</div>
		    ...
		    <input type="submit" class="btn btn-dark mx-2" value=" 문의사항 댓글 등록" />
