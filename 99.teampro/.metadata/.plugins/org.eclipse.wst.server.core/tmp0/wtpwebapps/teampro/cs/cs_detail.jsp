...
<body>
	...
	<div class="container mt-3" align="center">
		<form action="updateCs.do" method="post">
			<input name="seq" type="hidden" value="${cs.cs_seq}" />
			<div class="input-group mb-3">
  				<span class="input-group-text" id="desc_title"><i class="fas fa-address-book"></i></span>
  				<input type="text" class="form-control" name="cs_title" value="${ cs.cs_title }" disabled>
			</div>
			
			<div class="input-group mb-3">
  				<span class="input-group-text" id="desc_title"><i class="fas fa-user"></i></span>
  				<input type="text" class="form-control" name="cs_writer" value="${ cs.cs_writer }" disabled>
			</div>
			
			<div class="input-group mb-3">
			  <span class="input-group-text"><i class="fas fa-clipboard"></i></span>
			  <textarea class="form-control"  name="cs_content" rows="15" disabled>${ cs.cs_content }</textarea>
			</div>	
			
			<div class="input-group mb-3">
  				<span class="input-group-text" id="desc_title"><i class="fas fa-calendar"></i></span>
  				<input type="text" class="form-control" name="writer" value="${cs.cs_regdate }" disabled>
			</div>
			
			<div class="input-group mb-3">
  				<span class="input-group-text" id="desc_title"><i class="fas fa-hashtag"></i></span>
  				<input type="text" class="form-control" name="writer" value="${ cs.cs_filename }" disabled>
			</div>
